...
describe('User Registration', () => {
  ...
  it.each`
    ...
    ${'password'} | ${'lower4nd56789'} | ${'Password must have at least 1 uppercase, 1 lowercase and 1 number'}
    ${'password'} | ${'UPPER4ND5678'}  | ${'Password must have at least 1 uppercase, 1 lowercase and 1 number'}
