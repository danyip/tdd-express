...
describe('Authentication', () => {
  ...
  it('returns user id, username, token and image when login success', async () => {
...
describe('Logout', () => {
  it('returns 200 ok when unauthorized send for logout', async () => {
...
describe('Token Expiration', () => {
  ...
  it('refreshes lastedUsedAt when unexpired token is used', async () => {
    const savedUser = await addUser();
  ...
  it('refreshes lastedUsedAt when unexpired token is used for unauthenticated endpoint', async () => {
    const savedUser = await addUser();
